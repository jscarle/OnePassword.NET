...
{
    private protected static readonly string AccountAddress = Environment.GetEnvironmentVariable("OPT_ACCOUNT_ADDRESS") ?? "";
    private protected static readonly string AccountEmail = Environment.GetEnvironmentVariable("OPT_ACCOUNT_EMAIL") ?? "";
    private protected static readonly string AccountName = Environment.GetEnvironmentVariable("OPT_ACCOUNT_NAME") ?? "";
    private protected static readonly string AccountPassword = Environment.GetEnvironmentVariable("OPT_ACCOUNT_PASSWORD") ?? "";
    private protected static readonly string AccountSecretKey = Environment.GetEnvironmentVariable("OPT_ACCOUNT_SECRET_KEY") ?? "";
    private protected static readonly bool CreateTestUser = bool.Parse(Environment.GetEnvironmentVariable("OPT_TEST_USER_CREATE") ?? "false");
    private protected static readonly string TestEmail = Environment.GetEnvironmentVariable("OPT_TEST_USER_EMAIL") ?? "";
